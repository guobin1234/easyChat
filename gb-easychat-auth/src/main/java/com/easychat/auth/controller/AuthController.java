...
//        }
//
//        String cookieValue = userJwt.getId();
//        String cookieName = "uid";
//        String cookiePath = "/";
//
//        // 构造Set-Cookie头
//        String setCookieHeader = String.format("%s=%s; Path=%s; Max-Age=%d; SameSite=None; Secure",
//                cookieName, cookieValue, cookiePath, maxAge);
//
//        // 添加Set-Cookie头到响应头中
